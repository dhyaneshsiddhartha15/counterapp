...
function resetHandler(){
  ...
  <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-18">
    ...
    <div className="bg-white flex jusify-center gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
...
{count}
   ...
   <button onClick={resetHandler} className="bg-[#0398d4] text-white px-5 py-2 runded-sm text-lg">
      Reset
    </button>
    </div>
  );
